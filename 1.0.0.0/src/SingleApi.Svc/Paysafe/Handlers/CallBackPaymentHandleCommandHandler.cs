...
{
    public class CallBackPaymentHandleCommandHandler : IRequestHandler<CallBackPaymentHandleCommand, Result<CallBackPaymentHandleViewModel>>
    {
        ...
        public CallBackPaymentHandleCommandHandler(
